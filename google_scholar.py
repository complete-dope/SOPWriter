...
class GoogleScholarUser():
    ...
    def get_scholar_articles(self):
        ...
        # self.links = self.articles[0].find_all('td')
        # link = self.links[0].find('a')
        # # href values is 
        # hreff = link['href']
        ...
        # print("the articles are "  , self.articles)
        # print('\n')
        # print('\n')
        # print('\n')
        # print('\n')
        # print('\n')
        # print("len of articles is " , len(self.articles))
        # print('\n')
        # print('\n')
        # print('\n')
        # print("the tr links are " , self.links)
        # print('\n')
        # print('\n')
        # print('\n')
        # print('\n')
        # print("we stored the following values " , )
        # print(stored)
